...
class TestTableParser(unittest.TestCase):
    def test_pattern_checker_1a(self):
        # df_path = r"raw_data_postprocess\tests\test_cases\table_parser\date_header_in_1st_row_with_random_multiple_column.csv"
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\date_header_in_1st_row_with_random_multiple_column.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)
        pre_process_df = vitalTableParserObj.preprocess_df(dff)
        pattern_flag = vitalTableParserObj.pattern_1_checker(pre_process_df)
        self.assertEqual(pattern_flag, True)

    def test_pattern_checker_1b(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\date_header_in_2_row.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)
        pre_process_df = vitalTableParserObj.preprocess_df(dff)
    ...
    def test_pattern_checker_1c(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\single_date_header_in_row_with_comp_in_1st_col.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)
        pre_process_df = vitalTableParserObj.preprocess_df(dff)
    ...
    def test_pattern_checker_1d(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\all_header_containing_comp_and_date_in_zeroth_col.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)

        pre_process_df = vitalTableParserObj.preprocess_df(dff)
        pattern_flag_1 = vitalTableParserObj.pattern_1_checker(pre_process_df)
        self.assertEqual(pattern_flag_1, True)

    def test_pattern_checker_1e(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\date_header_in_2nd_row_with_random_column.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)
    ...
    def test_pattern_checker_1f(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\header_with_datetime_1st_col_has_comp.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)
    ...
    def test_pattern_checker_1g(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\first_col_empty_2nd_contains_time_and_header_has_components.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)
    ...
    def test_pattern_checker_1h(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\2nd_row_contains_header_and_1st_col_has_date.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)
    ...
    def test_pattern_checker_1i(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\date_in_last_col_comp_in_2nd_row.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)
    ...
    def test_pattern_checker_1j(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\false_date_present_in_first_row.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)
    ...
    def test_pattern_checker_2a(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\verticle_table_with_comp_date_val_column.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)
        ...
        self.assertEqual(pattern_flag_2, {
                         'lab_test_col': '0', 'date_col': 'Date Time', 'text': 'Result'})

    def test_pattern_checker_2b(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\all_the_headers_has_date_and_comp_in_last_row.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)
    ...
    def test_pattern_checker_2c(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\with_range_and_unit_col.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)
    ...
    def test_pattern_checker_2d(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\all_the_headers_has_comp_and_date_in_last_row.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)
    ...
    def test_pattern_checker_2e(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\less_number_of_comp_and_unkown_result_col.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)
    ...
    def test_pattern_checker_2f(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\null_header_for_pattern_2.csv"
        dff = pd.read_csv(df_path)
        vitalTableParserObj = TableParser(lab_master_list,
                                          lab_master_list, lab_unit_list)
        ...
        #     vitalTableParserObj.transpose_df(pre_process_df))
        self.assertEqual(
            column_dict, {'date_col': '0', 'lab_test_col': '1', 'text': '2'})

    def test_pattern_checker_multiheader_1a(self):
        df_path = r"raw_data_postprocess\tests\test_cases\table_parser\multiheader_date_table.csv"
        ...
        res1 = vitalTableParserObj.get_extracted_value_for_pattern_1(
            sub_df_list[0])
        # res_ = vitalTableParserObj.get_result_from_table_csv(dff)
        logging.debug(res1)
        # conct_res = []
        # for sbr in res_list:
    ...
    #     test_case_path = r"raw_data_postprocess\tests\test_cases\table_merger"
    ...
    def test_postprocess(self):
        test_case_df = pd.read_csv(
            r'raw_data_postprocess\tests\test_cases\post_process\postprocess_test_case.csv')
