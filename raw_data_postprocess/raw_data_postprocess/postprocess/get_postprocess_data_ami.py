...
class GetPostProcessData:
    ...
    def get_postprocess_data(self, pre_df, p_obj, default_year):
        ...
        if pre_df.shape[0] > 0:
            for i, row in pre_df.iterrows():
                ...
                if attr == 'Cardiac Troponin' and score>=self.attribute_thresholds['Cardiac Troponin']:
                ...
                elif attr == 'Sodium' and  score>=self.attribute_thresholds['Sodium']:
    ...
    def get_postprocess_data_for_excerpt(self, pre_df, p_obj, default_year, attribute_ls):
        ...
        for i, row in pre_df.iterrows():
            ...
            if row['TestName'] == "Cardiac Troponin":
        ...
        numeric_df = pre_df[pre_df['TestName'].isin(
            ["Cardiac Troponin", "Sodium", "Potassium"])] #"Creatine Kinase"
