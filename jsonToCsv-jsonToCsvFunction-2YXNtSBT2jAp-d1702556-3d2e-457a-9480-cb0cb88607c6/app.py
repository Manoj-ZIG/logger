...
def lambda_handler(event, context):
    ...
    try:
        print(f'Format conversion of python response to java response started: {file_name}')
        ...
        print(f'Format conversion of python response to java response completed: {file_name}')
