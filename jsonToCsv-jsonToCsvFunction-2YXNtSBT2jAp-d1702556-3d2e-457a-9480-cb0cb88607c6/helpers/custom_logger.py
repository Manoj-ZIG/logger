...
'format conversion of python response to java response':'Making the response Java compatible'
...
def custom_print(*args, **kwargs):
    ...
    if ":-" in message:
        ...
        if category_:
            ...
            values = f"{timestamp}|jsonToCsv-jsonToCsvFunction|{ARL}|{file_name_part}|{category_}|{Message}"
            content = f"{headers}\n{values}"
